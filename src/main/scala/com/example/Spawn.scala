...
object SpawnApp extends App {
  ...
  import SpawnGuardian._

  val system: ActorSystem[SpawnGuardian.Command] = ActorSystem(SpawnGuardian(), "guardian")
  system ! Start("some' ")
  //possible problem
...
object  NoJokeMan {
  ...
  case class Present(content: String) extends Command
